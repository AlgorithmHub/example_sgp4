...
%    vecef=[    -3.225636520  -2.872451450   5.531924446];
        ...
        [recigg,vecigg,aecig] = iau00f2i ( recef,vecef,aecef,ttt,jdut1,lod,xp,yp,'a', 0, 0 );
        fprintf(1,'GCRF          IAU-2006     %14.7f %14.7f %14.7f',recigg );
        fprintf(1,' v %14.9f %14.9f %14.9f',vecigg );
        fprintf(1,' a %14.9f %14.9f %14.9f\n',aecig );

        [recefg,vecefg,aecefg] = iau00i2f  ( recigg,vecigg,aecig,ttt,jdut1,lod,xp,yp,'a', 0, 0 );
        fprintf(1,'itrf                       %14.7f %14.7f %14.7f',recefg );
        fprintf(1,' v %14.9f %14.9f %14.9f',vecefg );
        fprintf(1,' a %14.9f %14.9f %14.9f\n',aecefg );

        % -------- ecef2eci    - transform iau2000 ecef to eci vectors
        [recigg,vecigg,aecig] = iau00f2i ( recef,vecef,aecef,ttt,jdut1,lod,xp,yp,'b', 0, 0 );
        fprintf(1,'GCRF          IAU-2000 B   %14.7f %14.7f %14.7f',recigg );
        fprintf(1,' v %14.9f %14.9f %14.9f',vecigg );
        fprintf(1,' a %14.9f %14.9f %14.9f\n',aecig );

        [recefg,vecefg,aecefg] = iau00i2f ( recigg,vecigg,aecig,ttt,jdut1,lod,xp,yp,'b', 0, 0  );
        fprintf(1,'itrf                       %14.7f %14.7f %14.7f',recefg );
        fprintf(1,' v %14.9f %14.9f %14.9f',vecefg );
        fprintf(1,' a %14.9f %14.9f %14.9f\n',aecefg );
        ...
        [recefg,vecefg,aecefg] = iau00i2f  ( recigg,vecigg,aeci,ttt,jdut1,lod,xp,yp,'c', ddx, ddy );
        fprintf(1,'itrf                       %14.7f %14.7f %14.7f',recefg );
        fprintf(1,' v %14.9f %14.9f %14.9f',vecefg );
        fprintf(1,' a %14.9f %14.9f %14.9f\n',aecefg );
        ...
        [ut1, tut1, jdut1, utc, tai, tt, ttt, jdtt, tdb, ttdb, jdtdb ] = convtime ( year, mon, day, hr, min, sec, timezone, dut1, dat );
        [recigans,vecigans,aecig] = iau00f2i ( recef,vecef,aecef,ttt,jdut1,lod,xp,yp,'c', ddx, ddy );
