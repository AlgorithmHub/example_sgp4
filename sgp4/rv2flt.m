...
%    vallado       2001, xx
%
% [magr,magv,latgc,lon,fpa,az] = rv2flt ( r,v,ttt,jdut1,lod,xp,yp,terms,ddpsi,ddeps );
% ----------------------------------------------------------------------------

function [magr,magv,latgc,lon,fpa,az] = rv2flt ( r,v,ttt,jdut1,lod,xp,yp,terms,ddpsi,ddeps );
...
%        latgc = atan2( recef(3) , sqrt(recef(1)^2 + recef(2)^2) );
        ...
        az = atan2( r(1)*hcrossr(2) - r(2)*hcrossr(1), hcrossr(3)*magr );
