...
%    tu = 1.0 / 58.132440906; % days in one solar tu
    ...
    jd1=jdayall(  1805,  9,   5, 24, 16,  5.000,'j');
    rtasc1 =   95.9897500/rad;
    decl1  =   22.35752222/rad;

    jd2=jdayall(  1806,  1,  17, 22,  9,  5.000,'j');
    rtasc2 =  101.3112083/rad;
    decl2  =   30.35672222/rad;

    jd3=jdayall(  1806,  5,  23, 20, 39,  9.000,'j');
    ...
    jd1=jdayall(  1990,  1,   1,  0,  0,  0.000,'j');
    rtasc1 =   hms2rad( 5, 41, 14.1 );
    decl1  =   dms2rad(26, 26,  0.0 );

    jd2=jdayall(  1990,  6,  12,  0,  0,  0.000,'j');
    rtasc2 =   hms2rad( 7, 59, 30.5 );
    decl2  =   dms2rad(26, 58, 15.0 );

    jd3=jdayall(  1990,  12, 25,  0,  0,  0.000,'j');
    ...
    % -------------------------------mars orbital observations
     jd1=jdayall(  1989, 12,  31,  0,  0,  0.000,'j');
     rtasc1 =   16.4429*15.0*pi/180.0;
     decl1  =   -21.711*pi/180.0;
     
     jd2=jdayall(  1990,  6,   9,  0,  0,  0.000,'j');
     rtasc2 =   0.4034*15.0*pi/180.0;
     decl2  =   0.507*pi/180.0;
 
     jd3=jdayall(  1990,  12, 26,  0,  0,  0.000,'j');
...
%    processtype = 'anglesl';
    [r2,v2] = anglesg ( decl1,decl2,decl3,rtasc1,rtasc2,rtasc3,jd1,jd2,jd3, rsite1,rsite2,rsite3, re, mu, tu );
